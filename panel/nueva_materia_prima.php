  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Almacén/Inventario</li>
        <li class="active">Nueva Materia Prima</li>
      </ol>
    </section>
            ...
            <!-- general form elements -->
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Nueva Materia Prima</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                            ...
                            <div class="form-row">
                                <div class="input-icon-group col-md-3 mb-3">
                                    ...
                                    <div class="input-icon-append">
                                        <input type="text" name="nombre-mp" class="form-control" placeholder="Mezclilla, polo ..." required>
                                    </div>
                                </div>
                                ...
                                <div class="input-icon-group col-md-3 mb-3">
                                    <label>Color</label>
                                    <div class="input-icon-append">
                                        <input type="text" name="color-mp" class="form-control" required placeholder="Rojo, Azul, Verde ...">
                                    </div>
                                </div>
